...
def calculateIndex(ds, climatStart, climatFinish, *args):
    """
    ...
    *args can be used for an xarray climatDs to use for climatology (if different to the main dataset)
    ...
    for key in index:
        ...
        domainClimatDs=sstDomain(climatDs, key)

        # First calculate the data range to use for climatology 
        domainSstClimat=climat.dateInterval(domainClimatDs, climatStart, climatFinish)
